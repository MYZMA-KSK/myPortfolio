...
export const projects: Project[] = [
  ...
  },
  {
    ...
    process: [
      ...
      { phase: '企画', title: 'リサーチ', description: '「ユーザーの新規アカウント開設」と「プラン変更の手続き」のワークフローについて、セールスチームメンバーにインタビューを実施して、ユーザーストーリーマップを作成' },
  ...
  },
  {
    ...
    process: [
      ...
      { phase: '制作', title: 'プロトタイピングの作成', description: 'メインタスクの動作を確認できるプロトタイプを作成することで、エンジニアは実装の作業ボリュームをイメージしやすくなり、精度の高い工数の見積もりが行うことができた' },
    ],
  },
  {
    slug: 'spaia',
