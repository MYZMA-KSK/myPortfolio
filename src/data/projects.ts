...
export const projects: Project[] = [
  ...
  },
  {
    ...
    process: [
      ...
      { phase: '制作', title: '情報設計', description: '「モードレスなUI」を実現するために、画面の構成をコレクション/シングルに整理。タスク支援のUIのうち分類して複数のオールインワンをセールスポイントにした多機能なアプリであっても、一貫性と明快な導線のある情報設計を追求', images: ['/images/projects/img-132.jpg'] },
      { phase: '制作', title: 'デザインガイドラインの作成', description: 'Atomic Designの考え方を本格的に採用して、先行してコントロールのUIコンポーネントからデザインを精緻化してライブラリ化。プロトタイプで検証した画面を、ライブラリから引用したUIコンポーネントで精緻化して作業の効率化と一貫性のあるデザインを実現', images: ['/images/projects/img-133.jpg'] },
